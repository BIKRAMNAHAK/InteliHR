...
const AllScreen = ({ navigation }) => {
  const menuItems = [
    ...
    { title: 'Leave', icon: 'airplane-outline', screen: 'Leave' },
    { title: 'Task', icon: 'book-outline' },
    { title: 'Timesheet', icon: 'time-outline' },
    { title: 'Finance', icon: 'document-text-outline' }, // renamed Payslip
    { title: 'Notices', icon: 'notifications-outline' }, // renamed Notice Board
    { title: 'Holidays', icon: 'sparkles-outline' },
    { title: 'Asset', icon: 'cube-outline' },
    ...
    { title: 'Outside Activity', icon: 'walk-outline' },
    { title: 'Gate Pass', icon: 'exit-outline' },
  ];
